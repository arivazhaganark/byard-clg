            ...
            <div class="box box-primary">
               <div  class="box-header breadcrum-fm">
                     ...
                     <span id="brdcrum" style="">
                        <a href="{{url('/user/filemanagersclstudent')}}" class="root">Home</a> &nbsp;&raquo;&nbsp;
                     </span>
                  </div>
               <!-- /.box-header -->
               <div class="box-body">
...
<input type="hidden" name="hid_file_search" id="hid_file_search" />
...
<script src="{{ asset('js/admin_pagejs/filemanager-scl-student-validation.js?v=1.0') }}"></script>
