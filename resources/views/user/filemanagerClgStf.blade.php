            ...
            <div class="box box-primary">
               <div  class="box-header breadcrum-fm">
                     ...
                     <span id="brdcrum" style="">
                        <a href="{{url('/user/filemanagerclgstf')}}" class="root">Home</a> &nbsp;&raquo;&nbsp;
                     </span>
                  </div>
               <!-- /.box-header -->
               <div class="box-body">
                        ...
                        <div id='headMenu' class="pull-right" style="display:block">
                            <form name="frm_search" id="frm_search" method="post" style="float: left;">     
                              ...
                              <input type="hidden" name="file_id" id="file_id">
                               ...
                               <input type="hidden" name="searchChk" id="searchChk">                          
...
<script src="{{ asset('js/admin_pagejs/filemanager-clg-staff-validation.js?v=4.90') }}"></script>
