         ...
         <div id="en" class="tab-pane fade in active">
            <div class="box box-primary">
               <div class="box-header breadcrum-fm">
                     ...
                     <span id="brdcrum">
                        <a href="{{url('/user/filemanager')}}" class="root">Home</a> &nbsp;&raquo;&nbsp;
                     </span>
                  </div>
               <!-- /.box-header -->
                </div>
               ...
               <div class="box-body">
                  ...
                  <section class="breadcrum">
                        ...
                        <div id='headMenu' class=" col-xs-12 col-sm-12 col-md-12 col-lg-12 buttons-fm">
                            <div class="pull-right">
                            <div class="half-width">
                            <form name="frm_search" id="frm_search" method="post" class="pull-left">     
                              {{ csrf_field() }}     
...
<input type="hidden" name="searchhidVal" id="searchhidVal" />
...
<script src="{{ asset('js/admin_pagejs/user-filemanager-staff-validation.js?v=2.8') }}"></script>
...
.context-menu-one-unpub,.context-menu-one a:> span
{
      display: block;
}
.aliSearchCls  
