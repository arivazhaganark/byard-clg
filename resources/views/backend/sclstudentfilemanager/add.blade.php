            ...
            <div class="box box-primary">
               <div align="center" class="box-header">
                     ...
                     <span id="brdcrum" style="float: left;">
                        <a href="{{url('/admin/schstffolder')}}" class="root">Home</a> &nbsp;&raquo;&nbsp;
                     </span>
                  </div>
               <!-- /.box-header -->
               <div class="box-body">
                  ...
                  <section class="breadcrum pt-10px pb-10px">
                     <div class="bg-lit">
                        <div id='headMenu' class="pull-right" style="display:none">
...
<script src="{{ asset('js/admin_pagejs/filemanager-validation.js?v=1.10') }}"></script>
