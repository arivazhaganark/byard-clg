...
<div class="container spark-screen" style="width:100%;">
    ...
    @endif 
    <div class="row">
        <div class="col-md-8 col-md-offset-2"> <a class="btn btn-app" href="{{ url('admin/schstaffsubmapp/add') }}" title="Add"> <i class="fa fa-plus"></i> Add </a>
                        ...
                        <tbody>
                            ...
                            <tr>          
                                <td>{{ $i }}</td>                        
                                 ...
                                 <td><!-- <a class="btn btn-default" href="<?php  //echo url('admin/schstaffsubmapp/edit/'.$schSubjectAll_data->scl_stf_sub_id); ?>" title="Edit"><i class="fa fa-edit"></i></a>  &nbsp;&nbsp; --><a class="btn btn-default" href="<?php  echo url('admin/schstaffsubmapp/show/'.$schSubjectAll_data->scl_stf_sub_id); ?>" title="View"><i class="fa fa-file-text"></i></a>     </td> 
                                <td><input name="chkall[]" id="chkall" class="chkall" type="checkbox" value="{{ $schSubjectAll_data->scl_stf_sub_id }}"></td>
                            </tr>
                            <?php $i++; ?>   
                            @endforeach
                            @else
