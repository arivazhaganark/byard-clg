...
<div class="container spark-screen" style="width:100%;">
    ...
    <div class="row">
        ...
        @if($uPermission[0]->file_add==1) <a class="btn btn-app" href="{{ url('admin/schsectionmap/add') }}" title="Add"> <i class="fa fa-plus"></i> Add </a> @endif
             @if($uPermission[0]->file_view==1 || $uPermission[0]->file_delete==1 || $uPermission[0]->file_edit==1)
            <a class="btn btn-app bg-green" href="{{ url('admin/schsectionmap') }}" title="Active"> <i class="fa fa-check-circle"></i>
                Active ({{ $active_count }}) </a>
            <a class="btn btn-app bg-red" href="{{ url('admin/schsectionmap/?token=inactive') }}" title="Inactive"> <i class="fa fa-ban"></i>
        ...
        <div class="col-xs-12">
            ...
            ?>">
                ...
                <div class="box-footer clearfix"> 
                    <form name="frm_action" id="frm_action" method="post" action="{{ url('/admin/schsectionmap/actionupdate') }}">
                        {{ csrf_field() }}
                    ...
                    <table @if($schsectionAll->count()>0) id="example1" @else id="" @endif class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>          
                                ...
                                <!-- <td><a class="btn btn-default" href="<?php //echo url('admin/schsectionmap/edit/'.$schsectionAll_data->sec_id); ?>" title="Edit"><i class="fa fa-edit"></i></a>  &nbsp;&nbsp;<a class="btn btn-default" href="<?php //echo url('admin/schsectionmap/show/'.$schsectionAll_data->sec_id); ?>" title="View"><i class="fa fa-file-text"></i></a>  </td> -->
                                <td>
                                  @if($uPermission[0]->file_delete==1)
                                 <input name="chkall[]" id="chkall" class="chkall" type="checkbox" value="{{ $schsectionAll_data->sch_cls_sec_map_id }}">
                                 @else
                                 ---
                                 @endif
                                 </td>
