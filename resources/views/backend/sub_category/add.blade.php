    ...
    <div class="container-fluid">
     ...
     <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="body">
            <form role="form" method="post" name="add_sub_category" id="add_sub_category" action="" onsubmit="return false;">
                {{ csrf_field() }}
                    ...
                    <div id="en" class="tab-pane fade in active">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title text-navy">Add Sub Category For "{{$category->name}}"</h3>
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    ...
                                    <input name="category_name" id="category_name" type="text" class="form-control" placeholder="Sub Category Name" value="" autocomplete="off" />
                                </div>
                                </div>

                                <div class="clearfix "></div>
                                <div class="box-footer">
                                    <button class="btn btn-primary" name="btn_add_sub_category" id="btn_add_sub_category" type="submit">Submit</button>
                                </div>
                            </div>
                            <!-- /.box-body -->
                            <!-- /.box -->
