...
<div class="container spark-screen" style="width:100%;">
    ...
    @endif 
    <div class="row">
        <div class="col-md-8 col-md-offset-2"> <a class="btn btn-app" href="{{ url('admin/userCreation/add') }}" title="Add"> <i class="fa fa-plus"></i> Add </a>

        <a class="btn btn-app bg-green" href="{{ url('admin/userCreation') }}" title="Active"> <i class="fa fa-check-circle"></i>
                Active ({{ $active_count }}) </a>
            <a class="btn btn-app bg-red" href="{{ url('admin/userCreation/?token=inactive') }}" title="Inactive"> <i class="fa fa-ban"></i>
        ...
        <div class="col-xs-12">
            ...
            ?>">
                ...
                <div class="box-footer clearfix"> 
                    <form name="frm_action" id="frm_action" method="post" action="{{ url('/admin/userCreation/actionupdate') }}">
                        {{ csrf_field() }}
                    ...
                    <table @if(count($UserAll)) id="example1" @else id="" @endif class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>          
                                ...
                                <td><a class="btn btn-default" href="<?php echo url('admin/userCreation/edit/'.$UserAll_data->id); ?>" title="Edit"><i class="fa fa-edit"></i></a></td>
