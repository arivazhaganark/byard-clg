...
<div class="container spark-screen" style="width:100%;">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <form role="form"  method="post" name="subjectFrm" id="subjectFrm" action="{{ url('admin/schsubject/store') }}">
                {{ csrf_field() }} 
                    ...
                    <div id="en" class="tab-pane fade in active">
                        <div class="box box-primary">
                            ...
                            <div class="box-body col-md-6" style="float: none;">
                                ...
                                <!-- <div class="form-group">
                                    <label id="username">Subject Code<span class="text-red">*</span></label>
                                    <input name="subcode" id="subcode" type="text"  class="form-control" placeholder="Subject Code" value="{!! old('subcode') !!}" autocomplete="off" />
                                </div> -->
