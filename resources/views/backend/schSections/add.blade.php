...
<div class="container spark-screen" style="width:100%;">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <form role="form"  method="post" name="sectionFrm" id="sectionFrm" action="{{ url('admin/schsection/store') }}">
                {{ csrf_field() }} 
                    ...
                    <div id="en" class="tab-pane fade in active">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <div class="pull-right"> <a style="margin-right:4px;" class="btn  btn-default btn-xs text-purple" href="{{ url('/admin/schsection') }}"><i class="fa fa-arrow-left"></i> Back</a> </div>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <!-- text input -->
...
<script src="{{ asset('js/admin_pagejs/schoolSection-validation.js?v=1.75') }}"></script>
<style type="text/css">
