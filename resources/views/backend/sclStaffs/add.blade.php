...
<div class="container spark-screen" style="width:100%;">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <form role="form" method="post" name="staffFrm" id="staffFrm" action="{{ url('admin/schstaff/store') }}" enctype="multipart/form-data">
                {{ csrf_field() }} 
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
        <form role="form" method="post" name="staffFrmBulk" id="staffFrmBulk" action="{{ url('admin/schstaff/bulkstore') }}" enctype="multipart/form-data">
