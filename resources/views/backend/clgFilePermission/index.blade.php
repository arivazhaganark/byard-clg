...
<div class="container spark-screen" style="width:100%;">
    ...
    @endif 
    <div class="row">
        <div class="col-md-8 col-md-offset-2"> <a class="btn btn-app" href="{{ url('admin/userClgFile/add') }}" title="Add"> <i class="fa fa-plus"></i> Add/Edit </a>
        ...
        <div class="col-xs-12">
            ...
            ?>">
                ...
                <div class="box-footer clearfix"> 
                    <form name="frm_action" id="frm_action" method="post" action="{{ url('/admin/userClgFile/actionupdate') }}">
                        {{ csrf_field() }}
                      ...
                      <!--           <th class="head_text">Edit</th> -->
                        ...
                        <tbody>
                            ...
                            <tr>          
                                ...
                                <!-- <td><a class="btn btn-default" href="<?php //echo url('admin/userClgFile/edit/'.$UserAll_data->id); ?>" title="Edit"><i class="fa fa-edit"></i></a></td> -->
