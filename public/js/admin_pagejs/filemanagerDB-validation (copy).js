var app_root = $('#app_url').val();
 ...
 function ajaxfm(pwd=null, file_id=null, search_txt=null,folderName=null) { 
     ...
     else
     {
       ...
       $.ajax({
           type: "POST",
           url: app_url + "/admin/schstfdbfolder/ajaxfm",
     ...
     if(fileid>0)
     {
      ...
      slinkPathArr.push(valSplitIdVal);
       ...
       if(slinkPathArr.length>0)
       {
        ...
        $.ajax({
        type: "POST",
        url: app_url + "/admin/schstfdbfolder/ajaxsearchfm",
    ...
    function clsLink(a)
    {
     ...
     function delete_file(cFileName=null,cFileIs=null,cFiledelPath=null) {
      ...
      $.ajax({
          type: "POST",
          url: app_url + "/admin/schstfdbfolder/delete",
   ...
   function createfolder(folderId=null,lkPathId=null) { 
       ...
       $.ajax({
           type: "POST",
           url: app_url + "/admin/schstfdbfolder/create_folder",
   ...
   function fnTs1(b)
   {
    ...
    $('#search_txt').val("")
      ...
      for(var i=0; i<brray.length;i++)
     {
          ...
          var valNavSplitId=brray[i].split('_')[1];
          if(valNavSplitId==b)
...
$('#brdcrum').html("");
var bPushVal='<a class="root" href='+app_url+'/admin/schstfdbfolder'+'>Home</a>&nbsp;&raquo;&nbsp;';
    ...
    //  alert(new_value);
     // alert(file_id)
      if(new_value !='') {
          $.ajax({
              type: "POST",
              url: app_url + "/admin/schstfdbfolder/rename",
...
function rename_folder(e) { 
    ...
    //  alert(new_value);
     // alert(file_id)
      if(new_value !='') {
          $.ajax({
              type: "POST",
              url: app_url + "/admin/schstfdbfolder/renameflder",
   ...
   function getBrdcrums(ids)
   {
    ...
    $.ajax({
           type: "POST",
           url: app_url + "/admin/schstfdbfolder/getBrdcrum",
...
Dropzone.options.imageUpload = {
           url: app_url +"/admin/schstfdbfolder/create_file",  
           maxFilesize: 10, //MB
