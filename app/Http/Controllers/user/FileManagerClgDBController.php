...
use DB;
use File;
class FileManagerClgDBController extends Controller
{
  public function index()
  {
    return view('user.filemanagerClgStf');
  }
              ...
              if ($chkParentchildCnt > 0) {
                ...
                foreach($chkParentchild as $key => $chkParentchildvalue) {
                  ...
                  if ($chkParentchildvalue->file_type == 'folder') {
                    ...
                    if (strtolower($ext) == 'mp3' || strtolower($ext) == 'mp4' || strtolower($ext) == 'mpeg') $ic = '<a  href="' . $urlPath . '" target="_blank"><i class="fa fa-video-camera fa-3x font-blue"></i></a><br/>';
